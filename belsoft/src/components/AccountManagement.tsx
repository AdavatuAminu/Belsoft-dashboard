  ...
  return (
    <section className="bg-white p-6 rounded-lg shadow-md w-[554px] h-[321px]">
      <div className="flex justify-between items-center mb-4">
        ...
        <a href="#" className="text-green-500 flex items-center text-[10px]">
          View More
          <Image src="/mingcute_arrows-right-line.png" alt="Arrow Logo" width={20} height={20} priority />
        </a>
      </div>
      <div className="grid grid-cols-5 gap-4 font-semibold text-gray-700 text-[13px] mb-2">
        <span>User ID</span>
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-5 gap-4 items-center text-[11px]">
          <span>#CCCS45</span>
          <div className="flex items-center text-[11px]">
            <div className="w-8 h-8 bg-gray-200 rounded-full mr-2 text-[11px]"></div>
          ...
          <button className="bg-green-600 text-white px-3 py-1 rounded flex items-center text-[11px]">
            Activate
          </button>
        </div>
        <div className="grid grid-cols-5 gap-4 items-center text-[11px]">
          ...
          <button className="bg-red-500 text-white px-3 py-1 rounded flex items-center text-[11px]">
            Deactivate
          </button>
        </div>
        <div className="grid grid-cols-5 gap-4 items-center text-[11px]">
